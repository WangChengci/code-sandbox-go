...
type FileServiceClient interface {
	...
	DeleteDir(ctx context.Context, in *DeleteFileRequest, opts ...grpc.CallOption) (*DeleteFileResponse, error)
...
func (c *fileServiceClient) DeleteDir(ctx context.Context, in *DeleteFileRequest, opts ...grpc.CallOption) (*DeleteFileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteFileResponse)
...
type FileServiceServer interface {
	...
	DeleteDir(context.Context, *DeleteFileRequest) (*DeleteFileResponse, error)
...
func (UnimplementedFileServiceServer) DeleteDir(context.Context, *DeleteFileRequest) (*DeleteFileResponse, error) {
...
func _FileService_DeleteDir_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).DeleteDir(ctx, req.(*DeleteFileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/protos/file/file.proto",
}
